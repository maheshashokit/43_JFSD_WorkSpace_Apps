...
public class StudentInsertSequenceDemo {
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		try(
			...
			String insert_query = "insert into ashokit_students values(ashokit_students_seq.nextval"+",'"+studentName+"','"+location+"','"+contactNo+"')";
