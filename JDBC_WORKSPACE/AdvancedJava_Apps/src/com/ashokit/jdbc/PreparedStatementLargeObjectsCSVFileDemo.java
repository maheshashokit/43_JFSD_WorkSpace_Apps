...
public class PreparedStatementLargeObjectsCSVFileDemo {
	...
	public static void main(String[] args) throws ClassNotFoundException {
		...
		File imageFile = new File("E:\\userProfile.jpg");
		File commentFile = new File("E:\\Clob_Text.txt");
		...
		try(
			...
			while(currentLine != null) {
				...
				pstmt.setInt(1, Integer.valueOf(customerValues[0]));//custId
				pstmt.setString(2, customerValues[1]);//custName
				pstmt.setString(3, customerValues[2]);//custLocation
				pstmt.setInt(4, Integer.valueOf(customerValues[3]));//billamount
				
				//Getting the date value as string
				String dateValueFromFile = customerValues[4];//purchaseDate
