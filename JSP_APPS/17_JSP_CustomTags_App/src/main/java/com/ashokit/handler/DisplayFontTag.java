	...
	public String getFontWeight() {
      ...
      public int doStartTag(){
		   ...
		   try{
			   ...
			   //color(CSS) >>>> textColor(userDefined Attribute);
			   //font-size(CSS) >>>>> size(userDefined Attribute)
			   //font-family(CSS) >>>>> font(userDefined Attribute)
			   //font-weight(CSS) >>>>> fontWeight(userDefined Attribute)
